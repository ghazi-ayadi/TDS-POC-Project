...
place_poses = [
    PoseObject(x=0.0, y=0.0, z=0.0, roll=0.947, pitch=1.502, yaw=2.945),  # Placeholder for 4 detected places
    PoseObject(x=0.0, y=0.0, z=0.0, roll=1.715, pitch=1.435, yaw=-2.633),
    PoseObject(x=0.0, y=0.0, z=0.0, roll=1.997, pitch=1.519, yaw=-2.298),
    PoseObject(x=0.0, y=0.0, z=0.0, roll=2.919, pitch=1.484, yaw=-1.308)
]
